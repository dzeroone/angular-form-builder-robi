  ...
  angular.module('builder.controller', ['builder.provider']).controller('fbFormObjectEditableController', [
    '$scope', '$injector', function($scope, $injector) {
      ...
      $scope.setupScope = function(formObject) {
        ...
        $scope.$watch('[label, description, placeholder, required, options, questions, direction, validation]', function() {
        ...
        $scope.$watch('questionsText', function(text) {
          var x;
          ...
          return $scope.inputText = $scope.questions[0];
        });
  ...
  angular.module('builder.provider', []).provider('$builder', function() {
    ...
    this.convertComponent = function(name, component) {
      ...
      result = {
        ...
        questions: (_ref9 = component.questions) != null ? _ref9 : [],
        direction: (_ref10 = component.direction) != null ? _ref10 : '',
    ...
    this.convertFormObject = function(name, formObject) {
      ...
      result = {
        ...
        questions: (_ref8 = formObject.questions) != null ? _ref8 : component.questions,
        direction: (_ref9 = formObject.direction) != null ? _ref9 : component.direction,
